...
//        MemberPrincipal memberPrincipal = new MemberPrincipal(MemberFixture.fixMember());
//        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(memberPrincipal, "", memberPrincipal.getAuthorities()));
//
